...
{
public:
  static Node popNode2D(vector<Node> &NodeList){
    float value = 10000;
    int idx = 0;
  ...
  static bool calAStarPath(const  nav_msgs::OccupancyGrid &m_map, const SPose &start , const SPose &end , vector<Node> &path){
